...
process.env.OIDC_ISSUER ??= 'http://localhost:8080/realms/citizens';
process.env.OIDC_CLIENT_ID ??= 'citizen-portal-api';
...
process.env.AUTH_POST_LOGIN_REDIRECT ??= 'http://localhost:3000';
