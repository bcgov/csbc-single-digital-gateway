  ...
  return (
    <footer className="mt-16 flex flex-col">
      ...
      <div className="bg-gray-110 text-white text-sm border-y-4 border-gold-60">
        <div className="my-8 mx-auto px-4 md:px-3 w-full max-w-285 flex flex-col gap-9">
      ...
      {/* Brand + link columns */}
      <div className="my-6 mx-auto px-4 md:px-3 w-full max-w-285 flex flex-col gap-9">
