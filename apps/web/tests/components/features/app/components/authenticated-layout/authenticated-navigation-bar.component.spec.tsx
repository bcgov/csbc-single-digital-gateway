...
jest.mock("src/features/app/components/navigation-bar", () => ({
  NavigationBar: ({
    title,
    items,
    extras,
...
import { AuthenticatedNavigationBar } from "src/features/app/components/authenticated-layout/authenticated-navigation-bar.component";
