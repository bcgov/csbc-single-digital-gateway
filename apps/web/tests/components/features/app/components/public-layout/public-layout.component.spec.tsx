...
jest.mock(
  "src/features/app/components/public-layout/public-footer.component",
  () => ({
    PublicFooter: () => (
...
jest.mock(
  "src/features/app/components/public-layout/public-header.component",
  () => ({
...
jest.mock(
  "src/features/app/components/public-layout/public-navigation-bar.component",
  () => ({
    PublicNavigationBar: () => (
...
import { PublicLayout } from "src/features/app/components/public-layout/public-layout.component";
