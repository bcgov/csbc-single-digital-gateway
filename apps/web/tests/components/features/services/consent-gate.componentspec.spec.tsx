...
import { ConsentGate } from "src/features/services/components/consent-gate.component";
...
const mockedConsentDocumentsQueryOptions =
  consentDocumentsQueryOptions as jest.Mock;
const mockedUseCreateConsentStatements =
  useCreateConsentStatements as jest.Mock;
...
describe("ConsentGate Component Test", () => {
  ...
  beforeEach(() => {
    ...
    mockedUseCreateConsentStatements.mockReturnValue({
  ...
  it("Should render consent documents, content state, and disabled submit button initially", () => {
    ...
    expect(mockedConsentDocumentsQueryOptions).toHaveBeenCalledWith([
      "doc-1",
      "doc-2",
    ]);
