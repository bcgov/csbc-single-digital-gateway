...
import { DocTranslationForm } from "./doc-translation-form.component";

interface AddDocTranslationDialogProps {
  docId: string;
  versionId: string;
...
export function AddDocTranslationDialog({
  docId,
  versionId,
  existingLocales,
  trigger,
}: AddDocTranslationDialogProps) {
