...
import { ServiceTypeVersionTranslationForm } from "./service-type-version-translation-form.component";

interface AddServiceTypeTranslationDialogProps {
  typeId: string;
  versionId: string;
...
export function AddServiceTypeTranslationDialog({
  typeId,
  versionId,
  existingLocales,
  trigger,
}: AddServiceTypeTranslationDialogProps) {
