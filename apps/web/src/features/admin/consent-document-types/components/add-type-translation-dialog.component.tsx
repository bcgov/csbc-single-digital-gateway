...
import { TypeVersionTranslationForm } from "./type-version-translation-form.component";

interface AddTypeTranslationDialogProps {
  typeId: string;
  versionId: string;
...
export function AddTypeTranslationDialog({
  typeId,
  versionId,
  existingLocales,
  trigger,
}: AddTypeTranslationDialogProps) {
