...
const renderAppProvider = ({
  ...
  jest.doMock("../../features/auth/auth.context", () => ({
    AuthProvider: ({
      idpType,
      defaultRedirectPath,
      lazy,
  ...
  jest.doMock("../../lib/react-query.client", () => ({
  ...
  const { AppProvider } = require("../provider") as {
...
describe("AppProvider Component Test", () => {
  afterEach(() => {
    ...
    jest.dontMock("../../features/auth/auth.context");
    jest.dontMock("../../lib/react-query.client");
