...
import { mockedUseQueryActual } from "tests/utils/mocks/tankstack/mock.useQueryActual";
...
describe("ConsentHistory Route Test", () => {
  beforeEach(() => {
    ...
    mockedUseQueryActual.mockReturnValue({
  ...
  describe("ConsentHistoryPage", () => {
    ...
    it("Should call consentTimelineQueryOptions with route search filters", () => {
      ...
      expect(mockedUseQueryActual).toHaveBeenCalledWith({
        queryKey: [
          "consent-timeline",
          {
            search: "privacy",
