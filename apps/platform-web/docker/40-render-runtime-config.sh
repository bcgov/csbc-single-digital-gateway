...
# SPA that points at localhost. $BFF_ORIGIN is the browser-facing origin of platform-api.
: "${BFF_ORIGIN:?BFF_ORIGIN must be set — the origin of this app's BFF, e.g. https://api.example.gov}"
