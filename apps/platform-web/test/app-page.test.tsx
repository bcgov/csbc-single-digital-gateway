...
const authedUser = {
  id: 'u1',
  roles: ['staff'],
  claims: { sub: 'subject-1', preferred_username: 'testuser' },
};
...
describe('platform-web /app page', () => {
  it('greets the authenticated user resolved from GET /auth/me', async () => {
    ...
    expect(await screen.findByRole('heading', { name: 'Hello, testuser.' })).toBeInTheDocument();
