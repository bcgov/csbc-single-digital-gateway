 ...
 * workspace. Disabled until there is one. Service jumps to the services screen; Application closes the
 * sheet and opens the application-type modal.
 */
export function NewSheet({ slug }: { slug: string | undefined }) {
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-3 p-4">
            ...
            >
              <OptionBody
                icon={FileText}
                title="Application"
                description="A form or multi-step wizard citizens fill in to apply."
              />
            </button>
          </div>
        </SheetContent>
      ...
      <ApplicationTypeModal open={appTypeOpen} onOpenChange={setAppTypeOpen} slug={slug} />
    </>
  );
}
