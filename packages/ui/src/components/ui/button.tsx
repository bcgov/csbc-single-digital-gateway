...
const buttonVariants = cva(
  "aria-invalid:ring-destructive/20 aria-invalid:border-destructive rounded-md border border-transparent bg-clip-padding text-base aria-invalid:ring-[3px] [&_svg:not([class*='size-'])]:size-4 inline-flex items-center justify-center whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 group/button select-none no-underline",
  {
    variants: {
      variant: {
        default:
        ...
        link: 'focus:outline-offset-1 text-primary underline-offset-4 hover:underline',
      },
      size: {
        default:
