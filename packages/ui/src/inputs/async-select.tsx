...
export function AsyncSelect({
  ...
  const selectValue = isMulti ? selectedOptions : (selectedOptions[0] ?? null);
    ...
    <div data-slot="async-select" className={cn('w-full', className)}>
      <AsyncPaginate
        ...
        classNames={{
          ...
          clearIndicator: () => 'text-muted-foreground hover:text-foreground cursor-pointer p-0',
          dropdownIndicator: () => 'text-muted-foreground hover:text-foreground cursor-pointer p-0',
          ...
          noOptionsMessage: () => 'text-muted-foreground px-2.5 py-4 text-center text-sm',
          loadingMessage: () => 'text-muted-foreground px-2.5 py-4 text-center text-sm',
