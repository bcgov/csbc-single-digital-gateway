...
CREATE TYPE "public"."consent_document_type_version_status" AS ENUM('draft', 'published', 'archived');--> statement-breakpoint
...
CREATE TYPE "public"."org_unit_type" AS ENUM('org', 'ministry', 'division', 'branch', 'team');--> statement-breakpoint
CREATE TYPE "public"."service_contributor_role" AS ENUM('owner');--> statement-breakpoint
CREATE TYPE "public"."service_type_version_status" AS ENUM('draft', 'published', 'archived');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "consent_document_type_version_translations" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"consent_document_type_version_id" uuid NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "consent_document_type_versions" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"consent_document_type_id" uuid NOT NULL,
	"version" integer NOT NULL,
	"status" "consent_document_type_version_status" NOT NULL,
...
CREATE TABLE "consent_document_types" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"published_consent_document_type_version_id" uuid,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "service_type_version_translations" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"service_type_version_id" uuid NOT NULL,
	"locale" text NOT NULL,
	"name" text NOT NULL,
	"description" text NOT NULL,
	"schema" jsonb DEFAULT '{}' NOT NULL,
...
CREATE TABLE "service_type_versions" (
	...
	"version" integer NOT NULL,
	"status" "service_type_version_status" NOT NULL,
	"archived_at" timestamp with time zone,
	"published_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
...
CREATE TABLE "service_types" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"published_service_type_version_id" uuid,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE "consent_document_type_version_translations" ADD CONSTRAINT "consent_document_type_version_translations_consent_document_type_version_id_consent_document_type_versions_id_fk" FOREIGN KEY ("consent_document_type_version_id") REFERENCES "public"."consent_document_type_versions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "consent_document_type_versions" ADD CONSTRAINT "consent_document_type_versions_consent_document_type_id_consent_document_types_id_fk" FOREIGN KEY ("consent_document_type_id") REFERENCES "public"."consent_document_types"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "consent_document_types" ADD CONSTRAINT "consent_document_types_published_consent_document_type_version_id_consent_document_type_versions_id_fk" FOREIGN KEY ("published_consent_document_type_version_id") REFERENCES "public"."consent_document_type_versions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "consent_document_versions" ADD CONSTRAINT "consent_document_versions_consent_document_type_version_id_consent_document_type_versions_id_fk" FOREIGN KEY ("consent_document_type_version_id") REFERENCES "public"."consent_document_type_versions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "service_type_version_translations" ADD CONSTRAINT "service_type_version_translations_service_type_version_id_service_type_versions_id_fk" FOREIGN KEY ("service_type_version_id") REFERENCES "public"."service_type_versions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "service_type_versions" ADD CONSTRAINT "service_type_versions_service_type_id_service_types_id_fk" FOREIGN KEY ("service_type_id") REFERENCES "public"."service_types"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "service_types" ADD CONSTRAINT "service_types_published_service_type_version_id_service_type_versions_id_fk" FOREIGN KEY ("published_service_type_version_id") REFERENCES "public"."service_type_versions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "service_versions" ADD CONSTRAINT "service_versions_service_type_version_id_service_type_versions_id_fk" FOREIGN KEY ("service_type_version_id") REFERENCES "public"."service_type_versions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "consent_document_type_version_translations_version_locale_unique" ON "consent_document_type_version_translations" USING btree ("consent_document_type_version_id","locale");--> statement-breakpoint
CREATE UNIQUE INDEX "consent_document_type_versions_consent_document_type_version_unique" ON "consent_document_type_versions" USING btree ("consent_document_type_id","version");--> statement-breakpoint
...
CREATE UNIQUE INDEX "service_type_version_translations_version_locale_unique" ON "service_type_version_translations" USING btree ("service_type_version_id","locale");--> statement-breakpoint
CREATE UNIQUE INDEX "service_type_versions_service_type_version_unique" ON "service_type_versions" USING btree ("service_type_id","version");--> statement-breakpoint
