...
ALTER TABLE "document_references" ADD CONSTRAINT "document_references_target_ws_global_only_chk" CHECK ("document_references"."target_workspace_id" IS NOT NULL OR "document_references"."relation" = 'service_agreement');--> statement-breakpoint
ALTER TABLE "document_references" ADD CONSTRAINT "document_references_relation_kind_chk" CHECK (("document_references"."relation" = 'related_service' AND "document_references"."target_kind" = 'service') OR ("document_references"."relation" = 'application_form' AND "document_references"."target_kind" IN ('basic-form', 'multi-stage-form')) OR ("document_references"."relation" = 'service_agreement' AND "document_references"."target_kind" = 'service-agreement'));